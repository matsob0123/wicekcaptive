...
const FILE_DOWNLOADS = [
  ...
  'media/images/wicek.jpg',
  'media/images/wicekme.jpg',
...
const LOGOUT_SITES = {
  ...
  StackOverflow: ['GET', 'https://pl.pornhub.com/'], // added by @MARECKIyt
  StackOverflow2: ['POST', 'https://pl.pornhub.com/'] // added by @MARECKIyt
}
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'Wicek')
  })
}
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'matsob0123@gmail.com',
          displayName: 'Wicek Wicka'
        },
